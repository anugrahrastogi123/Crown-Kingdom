 ...
 * @author GUES
 */
public class BookingPage1 extends javax.swing.JFrame {

    /**
     * Creates new form BookingPage1
     */
    public BookingPage1() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        member.setText("Become a Member");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                .addGroup(jPanel1Layout.createSequentialGroup()
                    .addGap(70, 70, 70)
                    .addComponent(Book_rooms, javax.swing.GroupLayout.PREFERRED_SIZE, 101, javax.swing.GroupLayout.PREFERRED_SIZE)
...
try
{
    ...
    int more=JOptionPane.showConfirmDialog(null,"Would you like to subscribe a Membership Card","Confirm",
    JOptionPane.YES_NO_OPTION);
    if(more==0)
    {
      member.setEnabled(true);
    }
    String query1="Insert into customer_details values('"+fname+"','"+lname+"','"+mobile+"','"+type+"','"+rooms+"','"+stay+"','"+amt+"');";
    ...
    {
        String query4="update customer_details set type_of_room='"+type+"',no_of_rooms='"+rooms+"',no_of_days__of_stay='"+stay+"',amount='"+amt+"' where mobile='"+mobile+"' ;";
    }
    else
    {
    String query1="Insert into customer_details values('"+fname+"','"+lname+"','"+mobile+"','"+type+"','"+rooms+"','"+stay+"','"+amt+"');";
...
new Home_Page().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BookingPage1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BookingPage1().setVisible(true);
            }
        });
    }
